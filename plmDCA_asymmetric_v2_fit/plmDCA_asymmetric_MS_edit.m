...
function plmDCA_asymmetric_MS_edit(fastafile,outputfile,nr_of_cores)
...
%Read inputfile (removing inserts), remove duplicate sequences, and calculate weights and B_eff.
    ...
    %%%%%%%%%%%%%CODE ADDED BY MS%%%%%%%%%%%%%%%%%%%%%%%%%
    %exports matrix of sequence vectors
    save('msa_seq_vectors.mat','Y')          
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%CODE ADDED BY MS%%%%%%%%%%%%%%%%%%%%%%%%%
    %exports matrix of sequence weights
    %order is for sequences in order of sequence matrix
    save('seq_weights.mat','weights')       
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%CODE ADDED BY MS%%%%%%%%%
%export matrix of h coefficients
%NOTE: not in Ising gauge!
%Use Python script to perform gauge transformation to get h in Ising gauge
    h = transpose(w(1:q,:));
    save('h.mat','h');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%CODE ADDED BY MS%%%%%%%%%%%%
%See 'A note on gauges' below
%exporting J matrices
%used for gauge transformation of h into Ising gauge
%NOT USED AS FINAL J COEFFIEICNTS
    save('Jtemp1.mat', 'Jtemp1')
    save('Jtemp2.mat', 'Jtemp2')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%CODE ADDED BY MS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%exporting J coefficient matrix in Ising gauge
%THESE ARE J COEFFICIENTS YOU WANT TO USE!
   save('J.mat','J')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
